...
* <ins>Si vous n'avez pas le logiciel AHK installé</ins> : téléchargez et exécutez le [B525-Manager.exe]([https://github.com/jibap/B525-Manager/blob/main/B525-Manager.exe](https://github.com/jibap/B525-Manager/releases/latest)) qui fera une extraction des fichiers annexes (script powershell, icones, config)
